...
vtkSmartPointer<vtkLagrangeHexahedron> fld::MakeLagrangeHex(std::size_t e, std::size_t nx)
{
  ...
  // https://discourse.vtk.org/t/vtknew-and-vtksmartpointer/469/10 For now, use
  // vtkSmartPointer: https://vtk.org/Wiki/VTK/Tutorials/SmartPointers
  ...
  std::vector<std::size_t> glid{gpt(e, 0, 0, 0),
                                gpt(e, nx - 1, 0, 0),
                                gpt(e, nx - 1, nx - 1, 0),
                                gpt(e, 0, nx - 1, 0),
                                gpt(e, 0, 0, nx - 1),
                                gpt(e, nx - 1, 0, nx - 1),
                                gpt(e, nx - 1, nx - 1, nx - 1),
                                gpt(e, 0, nx - 1, nx - 1)};
